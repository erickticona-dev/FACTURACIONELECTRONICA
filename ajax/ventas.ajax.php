...
public function ajaxGuardarVenta(){   
    ...
    $doc = array('moneda'=> $_POST['moneda'],
                 ...
                 $clienteBd =   array("nombre" => $_POST['razon_social'],
...
// GUARDAR VENTA
if(isset($_POST['ruta_comprobante']) && ($_POST['ruta_comprobante'] == 'crear-factura' || $_POST['ruta_comprobante'] == 'crear-boleta' || $_POST['ruta_comprobante'] == 'crear-nota')){
