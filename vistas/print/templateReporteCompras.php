...
$message .= "<tbody>
   <tr align='center' height='40' style='font-family:Verdana, Geneva, sans-serif;'>
    <th style='".$background." text-align:center;border-radius:15px 15px 0px 0px;'><a href='https://apifacturacion.com' style='color:#fff; text-decoration:none;font-size:20px; letter-spacing: 2px;'>REPORTE DE COMPRAS</a></th>
   </tr>
