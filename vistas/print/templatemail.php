...
$background = "background-image: linear-gradient( 109.6deg,  rgba(61,245,167,1) 11.2%, rgba(9,111,224,1) 91.1% );";
}
if($venta['tipocomp'] == '02'){
$background = "background-image: linear-gradient( 68.3deg,  rgba(245,177,97,1) 0.4%, rgba(236,54,110,1) 100.2% );";
}
...
$message .= "<thead >
   <tr height='80'>
    <th colspan='4' style='background-color:#fff; border-bottom:solid 1px #bdbdbd; font-family:Verdana, Geneva, sans-serif; color:#767676; font-size:34px;' ><a href='https://apifacturacion.com'><img src='https://sistem.apifacturacion.com/vistas/print/logo.png' width='150px'></img></a></th>
   </tr>
   <tr height='80'>
...
$message .= "<tbody>
   <tr align='center' height='40' style='font-family:Verdana, Geneva, sans-serif;'>
    <th style='".$background." text-align:center;border-radius:15px 15px 0px 0px;'><a href='https://apifacturacion.com' style='color:#fff; text-decoration:none;font-size:20px; letter-spacing: 2px;'>GRACIAS POR SU COMPRA</a></th>
   </tr>
   ...
   <tr>
    <td colspan='4' style='padding:15px;background-color:#fff; border: 1px solid #EEEEEE;'>
     ...
     COMROBANTE N°: ".$serie.'-'.$correlativo."<br>
     MONTO TOTAL: ".$tipoMoneda.' '.$venta['total']."<br>
     FECHA DE EMISIÓN: ".date("d-m-Y", strtotime($venta['fecha_emision']))."</p>
     <hr />
     <p style='font-size:20px; color:#696969;'>En el adjunto se encuentra su comprobante.</p>";
