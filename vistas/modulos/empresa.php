      ...
      <section class="container-fluid panel-medio">
          ...
          <div class="box rounded "style="margin:0px; padding:0px;">
           ...
           <form action="" id="formLogo" method="post" enctype="multipart/form-data">  
             ...
             </label>   <div class="panel" style="text-align: center; font-weight: bold; letter-spacing:1px; font-size: 14px">SUBIR LOGO <br />
            ...
            <!-- TERCERA ENTRADA -->
                <div class="col col-xs-12">
                  ...
                  <div class="col-md-2">
                     <div id="reloadC"></div>
                    <div class="form-group">
                    <label for="" class="lbl-text">Usuario sol SUNAT</label>
                     <div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-key"></i></span>                
                     <input type="text" class="form-control" id="usuario_sol" name="usuario_sol" placeholder="Usuario sol..." value="<?php echo $emisor['usuario_sol']; ?>">
                      </div>               
                     </div>
                    </div>
                  <!-- ENTRADA 3-->
                  <div class="col-md-2">
                     <div id="reloadC"></div>
                    <div class="form-group">
                    <label for="" class="lbl-text">Clave sol SUNAT</label>
                     <div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-key"></i></span>                
                     <input type="password" class="form-control" id="clave_sol" name="clave_sol" placeholder="Clave sol..." value="<?php echo $emisor['clave_sol']; ?>">
                      </div>               
                     </div>
                    </div>
                  <!-- ENTRADA 3-->
                  <div class="col-md-2">
                     <div id="reloadC"></div>
                    <div class="form-group">
                    <label for="" class="lbl-text">Clave certificado CDT</label>
                     <div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-key"></i></span>                
                     <input type="password" class="form-control" id="clave_certificado" name="clave_certificado" placeholder="Clave certificado..." value="<?php echo $emisor['clave_certificado']; ?>">
                      </div>               
                     </div>
                    </div>
                  <!-- ENTRADA 4-->
                  <div class="col-md-3">
                    ...
                    <div class="contenedor-selva">
                                    ...
                                    <div class="modo-contenedor-selva bienes-selva">
                                      ...
                                      <input type="checkbox" data-toggle="toggle" data-on="Sí" data-off="No" data-onstyle="success" data-offstyle="danger" id="bienesSelva" name="bienesSelva" value="s" data-size="small" data-width="80"
                                       <?php if($emisor['bienesSelva'] == 'n'){ }else{?>checked <?php } ?>>
                                      </div>

                                     
                                       <div class="modo-contenedor-selva servicios-selva">
                                          <label for="">¿Servicios Región Selva?</label>
                                        <input type="checkbox" data-toggle="toggle" data-on="Sí" data-off="No" data-onstyle="success" data-offstyle="danger" id="serviciosSelva" name="serviciosSelva" value="s" data-size="small" data-width="80" <?php if($emisor['serviciosSelva'] == 'n'){ }else{?>checked <?php } ?>>
                                        </div>
                                    </div> 
                    </div>
                    <!-- ÁREA DE CORREOS====================== -->
                    <div class="col col-xs-12">
                    <legend class="text-bold" style="margin-left:15px; font-size:1.3em; letter-spacing: 1px;">Correos:</legend>
                         <!-- ENTRADA 1 -->
                  <div class="col-md-6">
                     <div class="form-group">
                     <div class="input-group">
