                        ...
                        <div class="box box-success" style="border-top: 0px;">
                         ...
                         <div class="row" style="margin-bottom: 7px; padding-bottom: 4px;">
                                ...
                                <div class="box-tools pull-left ">  
                                  ...
                                  <label style="border-style:none;" id="emailtext" for=""> ¿Deseas Enviar el Comprobante al Email del Cliente?</label>
                                ...
                                <div class="row" style="margin-bottom: 7px; padding-bottom: 4px;">
                                <div class="col-md-6 email-colunma">
                                    <div class="form-group" >
                                    <div class="input-group">
                               ...
                               <tbody>
                                ...
                                <td colspan="2">
                                   ...
                                   <div class="modo-contenedor-selva">
                                      ...
                                      <input type="checkbox" data-toggle="toggle" data-on="Sí" data-off="No" data-onstyle="success" data-offstyle="danger" id="bienesSelva" name="bienesSelva" value="si" data-size="small" data-width="80" <?php if($emisor['bienesSelva'] == 'n'){ }else{?>checked <?php } ?>>
                                      </div>

                                     
                                       <div class="modo-contenedor-selva">
                                          <label for="">¿Servicios Región Selva?</label>
                                        <input type="checkbox" data-toggle="toggle" data-on="Sí" data-off="No" data-onstyle="success" data-offstyle="danger" id="serviciosSelva" name="serviciosSelva" value="si" data-size="small" data-width="80" <?php if($emisor['serviciosSelva'] == 'n'){ }else{?>checked <?php } ?>>
                                        </div>
                                    </div>  
                                    </div>  
                                      </td>
